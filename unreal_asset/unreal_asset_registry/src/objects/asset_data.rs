...
impl AssetData {
    ...
    pub fn new<Reader: ArchiveReader<impl PackageIndexTrait>>(
        ...
        let chunk_ids = ArchiveReader::read_array(asset, |asset: &mut Reader| Ok(asset.read_i32::<LE>()?))?; // if we don't explicitly specify the type inside the lambda the compiler will crash
